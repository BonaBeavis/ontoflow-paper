...
%%
%%
%% Commands for TeXCounthttps://www.overleaf.com/project/60c7324c55b5b405e39e2964
...
\author{Gordian Dziwis\inst{1} \and Lisa Wenige\inst{1}\orcidID{0000-0002-3707-3452} \and Lars-Peter Meyer\inst{1}\orcidID{0000-0001-5260-5181} \and Kirill Bulert\inst{1} \and Michael Martin\inst{1}\orcidID{0000-0003-0762-8688}}
\institute{Institute for Applied Informatics, Goerdelerring 9, Leipzig, Germany, \email{\{dziwis,wenige,lpmeyer,bulert,martin\}@infai.org}}
...
\begin{figure}[htb]
	...
	\end{tikzpicture}
	\caption{OntoFlow Execution Durations, for normal and all triple counts}
	\label{fig:eval}
\end{figure}
...
\iffalse
	\begin{figure}[ht]
		\begin{tikzpicture}
			...
			\fi
		\end{tikzpicture}
		\caption{OntoFlow Excecution Durations}
		\label{fig:eval}
	\end{figure}
\fi
