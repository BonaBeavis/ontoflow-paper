...
\begin{table*}[htb]
  ...
  \hline
  \multicolumn{2}{|l|}{\textbf{RQ1 ODP Automation}} \\
  \hline
  ...
  \hline
  \hline
  \multicolumn{2}{|l|}{\textbf{RQ2 High (Re-)Usability}} \\
  \hline
...
\label{tab:req}
\end{table*}\todo{smaller, lines to the left, add changed requirements}
...
\begin{itemize}
  ...
  \item Bubastis\footnote{https://github.com/EBISPOT/bubastis}: Creates a semantic diff to an older ontology version.\todo{cite https://academic.oup.com/bioinformatics/article/26/8/1112/208992}
...
\begin{figure}[h]
  ...
  \label{fig:copperkey}
\end{figure}\todo{remove metadata}
