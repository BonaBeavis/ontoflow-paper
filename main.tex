...
The user provides Chowlk diagrams, OWL files and SHACL shapes.
SHACL shapes are also provided by OntoFlow, those validate the ontology against a set of shapes, which check for best practices.\todo{right place for descrining what the shapes do?}
