...
A ontology diagram is visual representation of an ontology\todo{}
...
A set of validation shapes, which test the ontology for best practices\todo{enumerate}, are supplied by OntoFlow.
...
/todo{copperdigital as an example}
